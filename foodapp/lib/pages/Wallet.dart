        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TransactionCard(TransactionName: "Mutton Pulow", price: 29, color: Colors.green.shade700),
              TransactionCard(TransactionName: "Veg Mixed Curry", price: 29, color: Colors.orange.shade700),
              TransactionCard(TransactionName: "Aloo fry", price: 29, color: Colors.pink.shade700),
              TransactionCard(TransactionName: "Meals", price: 29, color: Colors.lime.shade700),
              TransactionCard(TransactionName: "Transaction1", price: 29, color: Colors.purple.shade700),
              TransactionCard(TransactionName: "Transaction1", price: 29, color: Colors.cyan.shade700),
            ],
          ),
        ),
      ),
